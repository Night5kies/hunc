      ...
      members: [
        {
          ...
          bio: `Hailee Youn is a senior from Long Island, New York, studying Government and Economics. She competes on the Radcliffe Varsity Lightweight Rowing team and previously served as President of the Harvard-Radcliffe Asian American Association. Hailee’s favorite spot in Harvard Square is the Grolier Poetry Book Shop, which is the oldest all-poetry shop in the country!`,
        },
        {
          name: 'Alice Liang',
          title: 'President',
          img: '/images/board/alice.jpeg',
          bio: `Alice Liang is a junior in Mather House from Shanghai, China, concentrating in Government with a secondary in Theater, Dance & Media and pursuing a citation in Spanish. Beyond her involvement with HUNC, she is active in Harvard Undergraduate Women in Foreign Policy and the Harvard Curling Club. Alice has a passion for modern dance, physical theater, and exploring global theater traditions, and she enjoys playing table tennis in her free time.`,
        },
      ],
    },
    {
      ...
      members: [
        {
          ...
          bio: `Emma Lucas is a third-year student at the College in the Social Studies and History of Science programs, along with a secondary in Comparative Literature. Having grown up in Austria, the US, and the UK, her passion for geography and geopolitics has followed her throughout her life. In addition to the strategy team, she is involved with the Undergraduate Architectural Society (HAUS) and the Science, Technology, and Society (STS) Fellowship at the Harvard Kennedy School.`,
        },
        {
          name: 'Heorhii Ambartsumov',
          title: 'Strategy Chair',
          img: '/images/board/heorhii.jpeg',
          bio: `Heorhii Ambartsumov is a junior studying physics and proudly residing in Lowell House. He is from Kyiv, Ukraine, but has been living in Toronto for the past two years. He spends most of his free time reading books and occasionally dreams about launching a startup.`,
        },
        {
          name: 'Rita Palácio',
          title: 'Strategy Chair',
          img: '/images/board/rita.jpeg',
          bio: `Rita Palácio is a junior in Mather House studying Government and Philosophy. She is from Portugal, and, outside of class, Rita can be found editing articles for the Harvard Undergraduate Law Review, singing karaoke with her PAFee in Weld, or playing the saxophone in the Jazz Combo Initiative.`,
        },
      ],
    },
    {
